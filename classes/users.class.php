...
class Users extends Database{
    ...
    public function get_merchants(){
     ...
     public function customers(){
        $stmt = $this -> connect()->prepare("SELECT * FROM users INNER JOIN user_profile ON users.user_id = user_profile.user_id INNER JOIN customers ON user_profile.user_id = customers.user_id");
        if(!$stmt -> execute()){
            $stmt = null;
